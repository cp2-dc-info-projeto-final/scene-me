        ...
        <div class="blink"></div>     
            <form action="loginImput.php" method="POST" >        
                <div class="col-md-4 offset-md-5 align-items-center">  
                    ...
                    <button type="submit" name="submit" class="btn btn-dark">Entrar</button><a class="btn btn-dark" href="index.php" role="button" style="position: relative; top: 3px; left:54%;">Voltar ao cadastro</a>                    
                </div>
             </form>          
		</div>
	</body>
