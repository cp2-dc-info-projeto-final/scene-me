        ...
        <div>
          <form action="cadastroReload.php" method="POST">              
            ...
            <div class="col-md-4 offset-md-4  align-items-center">
                ...
                <input type="text" class="form-control justify-content-center" id="nomeLabel" name="nome"  placeholder="nome">
            </div>
            <div class="col-md-4 offset-md-4 align-items-center">
                <label for="email" class="form-label"></label> 
                <input type="email" class="form-control justify-content-center" id="emailLabel" name="email" placeholder="email">
            </div>
            <div class="col-4 offset-md-4 align-items-center" style="color: rgb(0, 0, 0);">
                ...
                <input type="password" class="form-control justify-content-center " id="senhaLabel" name="senha" placeholder="senha" >
            </div>
